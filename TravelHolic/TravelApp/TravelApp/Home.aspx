      ...
      <section class="section about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="about-text">
             No matter who you are, or where you are going, our travel brands help every type of traveler not only find the trip that’s right for them, but get the best value every time. </p>
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <div class="about-item-content">
                  ...
                  <p class="about-item-text">
                    Our Prices are Affordable for normal people an well
                  </p>
                </div>
              ...
              <li class="about-item">
                ...
                <div class="about-item-content">
                  ...
                  <p class="about-item-text">
                    OUr tours are flexible for people with buisy schedule and trvelrs as well
                  </p>
                </div>
          ...
          <figure class="about-banner">
              <img src="Components/assets/images/about-banner.png" width="756" height="842" loading="lazy" alt="" class="w-100" />
          </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
          <img src="Components/assets/images/taj1.jpg" width="740" height="518" loading="lazy"
                  ...
                  <div class="card-wrapper">
                    ...
                    <div class="author-wrapper">
                      <figure class="author-avatar">
                          <img src="Components/assets/images/Bloger1.png" width="30" height="30"  />
                      </figure>

                      <div>
                        <a href="#" class="author-name">Ellie Cleary</a>

                        <p class="author-title">Blogger</p>
                      </div>
                    </div>

                    <time class="publish-time" datetime="10:30">May 24, 2022</time>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                      <img src="Components/assets/images/special-1.jpg" width="740" height="518"class="img-cover" />
                ...
                <div class="card-content">
                  ...
                  <div class="card-wrapper">
                    ...
                    <div class="author-wrapper">
                      <figure class="author-avatar">
                          <img src="Components/assets/images/author-avatar.png" width="30" height="30" alt="Gaurav Dutta" />
                      </figure>

                      <div>
                        <a href="#" class="author-name">Gaurav Dutta</a>

                        <p class="author-title">Traveller</p>
                      </div>
                    </div>

                    <time class="publish-time" datetime="10:30">june 1, 2021</time>

                  </div>

                  <h3 class="card-title">
                    <a href="https://traveltriangle.com/blog/places-near-pahalgam/">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                      <img src="Components/assets/images/destination-3.jpg" width="740" height="518" class="img-cover"/>
                ...
                <div class="card-content">
                  ...
                  <div class="card-wrapper">
                    ...
                    <div class="author-wrapper">
                      <figure class="author-avatar">
                          <img src="Components/assets/images/Bloger3.png" width="30" height="30" alt="Mani Arora"/>
                      </figure>

                      <div>
                        <a href="#" class="author-name">Mani Arora</a>

                        <p class="author-title">Blogger</p>
                      </div>
                    </div>

                    <time class="publish-time" datetime="10:30">Nov 28, 2023</time>

                  </div>

                  <h3 class="card-title">
                    <a href="https://traveltriangle.com/blog/holiday-homes-in-goa/">10 Holiday Homes In Goa For A Chilled-out Vacation With Family & Friends!
                    </a>
                  </h3>
  ...
  <footer class="footer" style="background-image: url('./assets/images/footer-bg.png')">
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <a href="#" class="logo">TravelHolic</a>

        <p class="copyright">
          &copy; 2022 <a href="#" class="copyright-link">Aadarsh</a>. All Rights Reserved
        </p>
