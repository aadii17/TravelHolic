<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Spackages.aspx.cs" Inherits="TravelApp.Spackages" %>
     ...
     <!-- 
      ...
      <section class="section popular">
        <div class="container">
          ...
          <h2 class="h2 section-title">Special Offers</h2>
            ...
            <li>
              <div class="popular-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="card-title">
                    <a class="button" href="TajBill.aspx">The Heritage Getaway - Agra & Mathura</a>
                  </h3>
...
<br><br>
          ...
          <ul class="popular-list">
            ...
            <p class="section-subtitle">Kashmir Special Offer</p>
          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="\Components\assets\images\special-1.jpg" width="740" height="518" loading="lazy"
                      alt="Kuala Lumpur, Malaysia" class="img-cover">
                  </a>
                ...
                <div class="card-content">
                  ...
                  <h3 class="card-title">
                    <a href="#">Delightful Kashmir Holiday</a>
                  </h3>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="\Components\assets\images\special-2.jpg" width="740" height="518" loading="lazy"
                      alt="Kuala Lumpur, Malaysia" class="img-cover">
                  </a>
